...
const Program = () => {
  return (
    <div className="mt-16 md:mt-24 py-12 px-4 max-w-7xl mx-auto"><br /> <br /> <br />
      <h2 className="text-3xl md:text-4xl font-bold text-center mb-10 text-orange-500 cursor-pointer">
        
      </h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 justify-items-center cursor-pointer">
        {programData.map((program, index) => (
          <div
            key={index}
            className="relative overflow-hidden rounded-xl shadow-lg group w-full max-w-sm md:max-w-xs"
          >
