  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-16 space-y-12">
      ...
      <div className="text-center">
        <br /> <br />
        <h1 className="text-4xl md:text-5xl font-extrabold text-gray-800 hover:text-slate-500 mb-4">
          About Us
        </h1>
      ...
      <div className="flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="relative w-full md:w-1/2 group">
          ...
          <img
            src={play}
            alt="Play Icon"
            className="absolute top-1/2 left-1/2 w-16 h-16 transform -translate-x-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 cursor-pointer"
          />
        </div>
